...
```{r danceability linear-model, echo= FALSE}
...
```{r Energy Linear Model, echo= FALSE}
...
```{r Speechiness Linear Model, echo= FALSE}
...
```{r Valence Linear Model, echo= FALSE}
...
```{r Tempo Linear Model, echo= FALSE}
...
```{r Overall Linear Model, echo= FALSE}
...
```{r group-dataset-by-season, echo= FALSE}
...
```{r season-visualization, fig.height= 2, fig.width= 5, echo= FALSE}
...
```{r season-energy-viz, fig.height= 2, fig.width= 5, echo= FALSE}
ggplot(data = season_data, 
...
```{r season-valence-viz, fig.height= 2, fig.width= 5, echo= FALSE}
ggplot(data = season_data, 
...
```{r season-energy-dance, fig.height= 2, fig.width= 5, echo= FALSE}
ggplot(data = season_data, 
...
```{r season-energy-speechiness, fig.height= 2, fig.width= 5, echo= FALSE}
ggplot(data = season_data, 
...
```{r dataset-for-top-song, echo= FALSE}
combined_1 <- combined %>%
  filter(week_position == 1)
```

```{r is-it-pop, echo= FALSE}
...
```{r null-distribution, echo= FALSE}
set.seed(1)
...
```{r visualizing-null-p-value, fig.height= 2, fig.width= 5, echo= FALSE}
visualize(null_dist) + 
